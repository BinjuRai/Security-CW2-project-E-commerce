      ...
      >
        ...
        <div className="flex justify-between items-center p-8 border-b border-[#f1d1d1]/20">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-serif italic text-[#494040]">
              The Bag
            </h3>
          </div>
          <button
                    ...
                    <p className="text-sm font-serif italic text-[#494040]/60 mb-4">
                      ...
                      {(
                        ...
                        (product.addons || []).reduce(
                          (sum, a) =>
                            sum + a.price * a.quantity * product.quantity,
                          0,
                        )
                      ).toLocaleString()}
                    </p>
                    ...
                    {product.addons && product.addons.length > 0 && (
                      <div className="mt-4 space-y-1">
                        ...
                        {product.addons.map((addon, i) => (
                          <div
                            key={i}
                            className="flex justify-between text-[10px] text-[#494040]/50 font-light"
                          >
                            <span>
        ...
        {cart.length > 0 && (
          <div className="p-8 border-t border-[#f1d1d1]/30 bg-[#fffcfc] space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-[#494040]/40 italic">
