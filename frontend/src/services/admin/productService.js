import { getAllProductApi, createProductApi, deleteOneProductApi, getProductsByCategoryApi, getProductByIdApi , updateProductApi} from "../../api/admin/adminProductApi";
