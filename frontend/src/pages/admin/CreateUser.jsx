...
import { useCreateUser } from '../../hooks/admin/useAdminUser';
import { useNavigate } from 'react-router-dom';
import { UserPlus, Mail, Lock, User, ChevronLeft, ShieldCheck, Loader2 } from 'lucide-react';
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#f1d1d1]/30 pb-10">
                        <div className="space-y-3">
                            ...
                            <h2 className="text-5xl font-serif italic tracking-tight">
                                Client <span className="font-sans not-italic font-light">Enrollment</span>
                            </h2>
                        ...
                        >
                            {isPending ? (
                                ...
                                <>
                                    ...
                                    <span className="text-[10px] font-bold tracking-[0.3em] uppercase">Complete Enrollment</span>
                                </>
                            )}
                        </button>
