      ...
      <div className="max-w-2xl mx-auto">
        ...
        <header className="mb-12">
          ...
          <h2 className="text-4xl font-serif italic text-[#494040]">
            Create{" "}
            <span className="font-sans not-italic font-light">Collection</span>
          </h2>
        ...
        <form
          ...
          className="space-y-10 bg-white border border-[#f1d1d1]/30 p-10 shadow-[0_10px_40px_rgba(73,64,64,0.02)]"
        >
          <div className="space-y-2">
            ...
            {formik.touched.name && formik.errors.name && (
              <p className="text-[9px] text-red-400 font-bold uppercase tracking-tight mt-1">
                {formik.errors.name}
              </p>
            )}
          </div>
            ...
            <div className="relative group">
              ...
              >
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <Upload
                    className="w-6 h-6 text-[#f1d1d1] mb-3 transition-transform group-hover:-translate-y-1"
                    strokeWidth={1.5}
                  />
                  <p className="text-[10px] font-bold tracking-widest uppercase text-[#494040]/40">
                    Select Visual Asset
                  </p>
                  <p className="text-[9px] text-[#494040]/20 mt-1 italic font-serif">
                    JPG, PNG up to 5MB
                  </p>
                </div>
              </label>
          ...
          <div className="pt-6 border-t border-[#f1d1d1]/20">
            ...
            {data && (
              <div className="mt-6 p-4 border border-[#f1d1d1]/50 bg-[#f1d1d1]/5 flex items-center justify-center gap-2">
                ...
                <p className="text-[10px] text-[#494040] font-bold uppercase tracking-[0.1em]">
